...
main() {
  final initialState = ApplicationState(tag: AppLaunchTag.main, failure: RemoteFailure(msg: 'RemoteFailure'), status: LoadingStatus.none);

  final tests = [
    [initialState.copyWith(tag: AppLaunchTag.main), ApplicationState(tag: AppLaunchTag.main, status: initialState.loadingStatus)],
    [
